...
namespace ENV
{
    public abstract class ControllerBase
    {
        ...
        /// <summary>
        /// Used only to support the UserMethods.VarName method. By Defalut the VarName would return Virtual.Caption, but for columns that were sent as paramters to the MarkParameterColumn the VarName method would return Parameter.Caption
        /// </summary>
        ...
        protected void SetView(Func<Form> value, Action<Form> setTaskView, Action<Form> setDefaultContextMenu, bool forceApplyIcon)
        {
            ...
            if (ff != null && _application != null)
                ff.DoControllerLoad(_application != null && !_application.RunnedAsApplication);
