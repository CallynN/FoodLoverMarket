        ...
        public abstract class Message
        {
            ...
            protected void FetchBody()
            {
                    ...
                    Action addPart =
                        () =>
                        {
                            ...
                            if (name == "" && currentPartContentType.ToUpper(CultureInfo.InvariantCulture).Contains("TEXT"))
                                setText(currentPartData.ToString(), currentPartContentTransferEncoding);
                            else
                            {
                                try
                                {
                                    _attachments.Add(new Attachment(name, System.Convert.FromBase64String(currentPartData.ToString())));
                                }
                                catch (Exception e)
                                {
                ...
                else
                {
                    ...
                    setText(body, _contentTransferEncoding);
                }
