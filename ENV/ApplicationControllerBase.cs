...
namespace ENV
{
    ...
    public class ApplicationControllerBase : IHaveUserMethods
    {
        ...
        void myLoad()
        {
            ...
            Commands.FindNextRow.AddTo(Handlers, CustomerFilterSortAndFindHandler);
            ...
            ConfirmExit.Invokes +=
                e =>
                {
                    ...
                    if (ENV.Common.ShowYesNoMessageBox(LocalizationInfo.Current.ExitApplication, LocalizationInfo.Current.ConfirmExitApplication, false))
