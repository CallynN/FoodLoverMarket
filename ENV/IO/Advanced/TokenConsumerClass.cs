    ...
    class TokenConsumerClass : TokenConsumer
    {
        ...
        class rootConsumer : TokenConsumer
        {
            ...
            public virtual void Token(string token)
            {
                ...
                {
                    case "REPEAT":
                        _parent._currentConsumer = new RepeatTokenReader(this);
                        break;
                    case "INCLUDE":
            ...
            class RepeatTokenReader : rootConsumer
            {
                ...
                public RepeatTokenReader(rootConsumer prev)
                    : base(prev._parent)
                {
                    _prev = prev;
                }
                public override void Token(string token)
                {
                    ...
                    {
                        case "ENDREPEAT":
                            _prev._set.Add(new RepeatToken(_set.Build()));
                ...
                class RepeatToken : IToken
                {
                    ...
                    {
                        return new RepeatToken(_set.Duplicate());
                    }
