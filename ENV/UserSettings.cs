...
namespace ENV
{
    ...
    public static class UserSettings
    {
            ...
            bool saveToContext)
        {
            ...
            switch (upperSection)
            {
                case MAGIC_ENV:
                    ...
                    switch (upperEntryName)
                    {
                        ...
                        case "ALLOWCREATEINMODIFY":
                            DefaultAllowInsertInUpdateActivity = upperValue != "N";
                            break;
                        case "COPYRIGHTMESSAGES":
                            Common.ShowSpecificMDIText = upperValue == "Y";
                            break;
                        ...
                        case "REPOSITIONAFTERMODIFY":
                            ReloadDataAfterUpdatingOrderByColumns = upperValue == "Y";
                            break;
                        case "ALLOWUPDATEINQUERY":
                            SuppressUpdatesInBrowseActivity = upperValue == "N";
                            break;
                        case "LOADRESIDENTFILES":
                            ENV.Data.DataProvider.EntityNameAcordingToCallStackEntityDataProviderDecorator.DisableInMemoryEntityLoading = upperValue == "N";
                            break;
                        ...
                        case "STARTAPPLICATION":
                            ...
                            break;
                        case "RESIDENTINI":
                            _saveOnEveryChange = upperValue == "N";
                            break;
                        case "ISAMTRANSACTION":
                            ConditionalTransaction = upperValue == "N";
                            ConnectionManager.EnableBtrieveTransactions = upperValue == "Y";
                            break;
                        ...
                        case "DATEMODE":
                            ...
                            else if (upperValue == "S" || upperValue == "J")
                        ...
                        case "DATESEPARATOR":
                            if (value.Length == 0)
                                value = ",";
                            if (saveToContext)
                                Date.DateSeperator.SetContextValue(value[0]);
                            if (saveToShared)
                                Date.DateSeperator.SetSharedValue(value[0]);
                            break;
                        case "THOUSANDSEPARATOR":
                            if (value.Length == 0)
                                value = " ";
                            if (saveToContext)
                                Number.GroupSeperator.SetContextValue(value[0]);
                            if (saveToShared)
                                Number.GroupSeperator.SetSharedValue(value[0]);
                            break;
                        case "DECIMALSEPARATOR":

                            if (saveToContext)
                                Number.DecimalSeperator.SetContextValue(value[0]);
                            if (saveToShared)
                                Number.DecimalSeperator.SetSharedValue(value[0]);
                            break;
                        case "USER":
                        ...
                        case "PASSWORD":
                            ...
                            break;
                        case "INPUTPASSWORD":
                            Security.UserManager.DisplayLoginDialog = upperValue == "Y";
                            break;
                        case "INPUTDATE":
                            Security.Tasks.Login.InputDate = upperValue == "Y";
                            break;
                        case "SYSTEMLOGIN":
                            if (upperValue == "L")
                            {
                            ...
                            else if (upperValue == "D")
                            {
                                ...
                                UserManager.DisplayLoginDialog = true;
                            }
                        ...
                        case "PROFILER":
                            ...
                            break;
                        case "PROFILERTRACE":
                            ENV.Utilities.Profiler.Tracing = upperValue == "Y";
                            break;
                        case "PROFILERTARCKCOMMANDS":
                        case "PROFILERTRACKCOMMANDS":
                            Profiler.TrackCommandsAndReaders = upperValue == "Y";
                            break;
                        case "MEMORYMONITOR":
                            if (upperValue == "Y")
                                MemoryMonitor.Run();
                        ...
                        case "ALLWAYSSHOWDBERRORS":
                            Common.AllwaysShowDBErrors = upperValue == "Y";
                            break;
                        case "TRACEFILE":
                            if (saveToContext)
                            ...
                            break;
                        case "DBDEBUG":
                            ConnectionManager.DatabaseLogToDebugOutput = upperValue == "Y";
                            break;
                        case "DBNOPARAMS":
                            ConnectionManager.UseDBParameters = !(upperValue == "Y");
                            break;
                        case "ODBCNOPARAMS":
                            ConnectionManager.OdbcDbParameters = !(upperValue == "Y");
                            break;
                        case "HELPFILE":
                            ApplicationControllerBase.DefaultHelpFile = value;
                            break;
                        case "DISPLAYFULLMSGS":
                            Common.DisplayDatabaseErrors = upperValue == "Y";
                            break;
                        ...
                        case "LOGOFILE":
                            ...
                            break;
                        case "EMBEDFONTS":
                            ENV.Printing.PrinterWriter.UseEmbeddedFontsInPdf = upperValue != "N";
                            break;
                ...
                case "MAGIC_SPECIALS":
                    ...
                    {
                        case "SPECIAL3DSTYLE":
                            FixedBackColorInNonFlatStyles = upperValue == "N";
                            break;
                        case "SPECIALASYNCCOMEVENTS":
                            AsyncComEvents = upperValue == "Y";
                            break;
                        case "SPECIALTRIMPARAMDSQL":
                            Data.DynamicSQLEntity.DefaultTrimTextColumnParameterValues = upperValue == "Y";
                            break;
                        case "SPECIALSKIPINMULTIEDIT":
                            AllowLeaveTextboxUsingArrowKeysInMultiline = upperValue == "Y";
                            break;
                        case "CLOSEPRINTEDTABLESINSUBTASKS":
                            RestartTableOnTaskClose = upperValue == "Y";
                            break;
                        case "HIGHRESOLUTIONPRINT":
                            BackwardCompatibleLowResolutionPrinting = upperValue == "N";
                            break;
                        case "SPECIALOLDZORDER":
                            DisableMDIChildZOrdering = upperValue == "Y";
                            break;
                        case "SPECIALPAINTFORMINCREATE":
                            AlwaysKeepNewRowValuesVisibleAfterExit = upperValue == "Y";
                            break;
        ...
        public static bool VersionXpaCompatible { get; set; }
