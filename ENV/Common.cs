...
namespace ENV
{
    public static class Common
    {
        ...
        public static string ApplicationTitle { get { return ENV.PathDecoder.DecodePath(_applicationTitle); } set { _applicationTitle = value; } }
        ...
        {
            if (!_suppressDialogForTesting && !string.IsNullOrEmpty(text))
            {
                SystemSounds.Beep.Play();
                SystemSounds.Beep.Play();
            }
        ...
        public static bool AlwaysUseEnglishUSCultureForTry = true;
        ...
        public static bool DoNotSaveMdiDimentions = false;
