...
namespace ENV.UI
{
    public partial class Grid : Firefly.Box.UI.Grid
    {
        ...
        protected override void OnLoad()
        {
            ...
            if (ActiveRowStyle == Firefly.Box.UI.GridActiveRowStyle.Border && ActiveRowForeColor == SystemColors.HighlightText)
                ActiveRowForeColor = Color.Black;
        ...
        class CustomGridPainter : IGridPainterUnderConstructionInterfaceWILLCHANGE
        {
            ...
            public Image DrawColumnTitle(Rectangle columnRect, bool showColumnSeperator, bool mouseOver, bool mousePressed)
            {
