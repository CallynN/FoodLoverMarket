...
namespace ENV
{
    ...
    public class TemplateModeFilter : IUIControllerFilterUI
    {
                                    ...
                                    {
                                        {
                                            ...
                                            if (x != null && y == null)
                                                SetMenuesActivities(x.Items, restoreState);
                                        }
                                    }
                            });
                    });
        ...
        bool SetMenuesActivities(ToolStripItemCollection collection, List<Action> restoreState)
        {
            ...
            foreach (ToolStripItem item in new System.Collections.ArrayList(collection))
            {
                ...
                if (dd != null)
                {
                    hasActiveInIt = SetMenuesActivities(dd.DropDownItems, restoreState);
                }
                var i = item;
