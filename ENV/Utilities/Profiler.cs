...
namespace ENV.Utilities
{
    public class Profiler
    {
        ...
        public static void Start()
        {
            ...
            new EntryDisposable("Entire Session");
        }
        ...
        class EntryDisposable : IDisposable, IProfilerEntry
        {
            ...
            public EntryDisposable(string e)
                : this(e, CurrentEntry.Value)
            {
            }

            long _myProfilingSessionID;
            string _name;
            public EntryDisposable(string e, EntryDisposable parent)
            {
        ...
        public static IDisposable Controller(ControllerBase controllerBase)
        {
            ...
            return StartContext(controllerBase.GetType().FullName);
        }

        public static IDisposable StartContext(string name)
        {
            if (DoNotProfile())
                return DummyDisposable.Instance;
            return new EntryDisposable(name);
        }
        ...
        class ProfiledTransaction : IDbTransaction
        {
            ...
            public IDbTransaction GetTrans()
            {
                return _trans;
            }
        }
        ...
        static void ToggleProfiling()
        {
            if (DoNotProfile())
            {
                ...
                x += "Profiler_" + Date.Now.ToString("YYYYMMDD") + "T" + Time.Now.ToString("HHMMSS") + ".prof";
        ...
        public static IDisposable EntiyCommand(Entity entity, string command)
        {
            if (DoNotProfile())
                return DummyDisposable.Instance;
