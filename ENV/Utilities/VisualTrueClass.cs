...
namespace ENV.Utilities
{
    internal class VisualTrueClass
    {
        ...
        {
            VisualTrueClass _parent;
            List<char> _seperatorChars = new List<char>();
            ...
            {
                _saveTheNumber(true);
                foreach (char seperatorChar in _seperatorChars)
                {
                    _parent._sb.Append(HebrewTextTools.ReverseBracks(seperatorChar));
                }
                _seperatorChars.Clear();
                _parent.SwitchToHebrew(c);
            }
            ...
            public void English(char c)
            {
                ...
                _parent.Insert(_seperatorChars);
                _parent.SwitchToEnglish(c);
            }
                ...
                _parent.SwitchToNumber(c, delegate { },
                                       delegate (bool obj)
                                       {
                                           ...
                                           if (obj)
                                           {
                                               ...
                                               _seperatorChars.Reverse();
                                           }
                                           if (_reverse && obj)
                                               _parent.Insert(HebrewTextTools.ReverseBracks(new string(_seperatorChars.ToArray())));
                                           else
                                               _parent.Insert(_seperatorChars);
                                       }, false);
            }
