                        ...
                        () =>
                        {
                            try
                            {
                                ...
                                if (Context._builders.TryGetValue(locateName, out connectionBuilder))
                                    return myResult = connectionBuilder(disableTransactions).GetDataProvder();
                                return myResult = (connectionBuilder = Shared._builders[locateName])(disableTransactions).GetDataProvder();
                            }
