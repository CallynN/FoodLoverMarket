...
namespace ENV.Advanced
{
    class LevelProvider
    {
        ...
        {
            return StartContext((_isModuleController ? "M" : "T") + "P", "TP","OnStart");
        }
        ...
        {
            return StartContext((_isModuleController ? "M" : "T") + "S", "TS","OnEnd");
        }

        public static void StartEnterControlContext(Action action, InputControlBase control)
        {
            StartEnterControlContext(action, control, "CP");
        }
        public static void StartInputValidationControlContext(Action action, InputControlBase control)
        {
            StartEnterControlContext(action, control, "CV");
        }
        public static void StartLeaveControlContext(Action action, InputControlBase control)
        {
            StartEnterControlContext(action, control, "CS");
        }
        public static void StartChangeControlContext(Action action, InputControlBase control)
        {
        ...
        static void StartEnterControlContext(Action action, ControlBase control, string s)
        {
