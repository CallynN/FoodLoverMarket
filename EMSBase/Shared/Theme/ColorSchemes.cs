...
namespace EMS.Shared.Theme
{
    ...
    public class ColorSchemes
    {
        static ColorSchemes()
        {
            ...
            _map.Add(101, new Colors.ScreenModeCaption());
            _map.Add(102, new Colors.defaultLable());
            _map.Add(103, new Colors.test2());
            _map.Add(104, new Colors.traingDefaultLable());
            _map.Add(105, new Colors.GreenLight());
            _map.Add(106, new Colors.YellowLight());
            _map.Add(107, new Colors.OrangeLight());
            _map.Add(108, new Colors.RedLight());
        }
