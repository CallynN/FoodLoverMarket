...
namespace EMS.Shared.Theme
{
    ...
    public class FontSchemes
    {
        static FontSchemes()
        {
            ...
            _map.Add(37, new Fonts.VariablePalette());
            _map.Add(38, new Fonts.Reserved_9());
            _map.Add(39, new Fonts.Reserved_10());
            _map.Add(40, new Fonts.Reserved_11());
            _map.Add(41, new Fonts.Reserved_12());
            _map.Add(42, new Fonts.Reserved_13());
            _map.Add(43, new Fonts.Reserved_14());
            _map.Add(44, new Fonts.Reserved_15());
            _map.Add(45, new Fonts.Reserved_16());
            _map.Add(46, new Fonts.Reserved_17());
            _map.Add(47, new Fonts.Reserved_18());
            _map.Add(48, new Fonts.Reserved_19());
            _map.Add(49, new Fonts.Reserved_20());
            ...
            _map.Add(78, new Fonts.Reserved_21());
            _map.Add(79, new Fonts.Reserved_22());
            _map.Add(80, new Fonts.Reserved_23());
            _map.Add(81, new Fonts.WizardLargeTitle());
            _map.Add(82, new Fonts.WizardSmallTitle());
            _map.Add(83, new Fonts.WizardText());
            _map.Add(84, new Fonts.Reserved_24());
            _map.Add(85, new Fonts.Reserved_25());
            _map.Add(86, new Fonts.Reserved_26());
            _map.Add(87, new Fonts.Reserved_27());
            _map.Add(88, new Fonts.Reserved_28());
            _map.Add(89, new Fonts.Reserved_29());
            _map.Add(90, new Fonts.Reserved_30());
            _map.Add(91, new Fonts.Reserved_31());
            _map.Add(92, new Fonts.Reserved_32());
            _map.Add(93, new Fonts.Reserved_33());
            _map.Add(94, new Fonts.Reserved_34());
            _map.Add(95, new Fonts.Reserved_35());
            _map.Add(96, new Fonts.Reserved_36());
            _map.Add(97, new Fonts.Reserved_37());
            _map.Add(98, new Fonts.Reserved_38());
            _map.Add(99, new Fonts.Reserved_39());
            _map.Add(100, new Fonts.Reserved_40());
            ...
            _map.Add(111, new Fonts.ScreenModeCaption());
            _map.Add(112, new Fonts.StrikeThrough());
            _map.Add(113, new Fonts.ReportFont());
            _map.Add(114, new Fonts.ReportFont2());
            _map.Add(115, new Fonts.certificateFont1());
            _map.Add(116, new Fonts.certificateFint2());
            _map.Add(117, new Fonts.certificateFont3());
            _map.Add(118, new Fonts.RegisterFont());
        }
