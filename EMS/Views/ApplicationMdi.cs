...
namespace EMS.Views
{
    partial class ApplicationMdi : System.Windows.Forms.Form,IHaveAMenu 
    {
        ...
        public ApplicationMdi()
        {
            ...
            Common.MDILoad(this);
            new ENV.UI.Menus.DeveloperToolsMenu(Application.Instance, typeof (Shared.DataSources), Roles.UserManager).AddToContextMenu(_menuManager, _optionsContextMenuStrip);
        }
        ...
        {
           // Create<EMS.ItemMasterdata.I_03189OrderableSellableUtility>().Run();
        }

        private void cashBankingToolStripMenuItem_Click(object sender, EventArgs e)
        {
        ...
        {
            //new CalcShortAndOvers.CashierShortAndOverCalc().Run();
            //Create<EMS.CalcShortAndOvers.CashierShortAndOverCalc>().Run();
            //Create<EMS.CalcShortAndOvers.DailyZReadingDetails>().Run();
        }
